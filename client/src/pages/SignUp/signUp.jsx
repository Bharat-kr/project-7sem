               ...
               [ shadow-black/70 shadow-2xl ]">
                ...
                <div className="input-container">
                    ...
                    <div className="input-div">
                        ...
                        <input 
                        // onChange={(e) => handle(e)} 
                        type="mail" placeholder="youremail@gmail.com" id="email" name="mail" />
                    ...
                    {type &&
                        <div className="input-div" style={{ display: 'flex', gap: '1rem' }}>
                            <div style={{ display: 'flex', flexDirection: 'column' }}>
                                ...
                                type="text" placeholder="Specialization" id="email" name="speciality" />
                            </div>
                            <div style={{ display: 'flex', flexDirection: 'column' }}>
                                <div className="input-heading">
                                    <i className="fas fa-key"></i>
                                ...
                                <input 
                                // onChange={(e) => handleD(e)} 
                                type="text" placeholder="License No." id="email" name="license" />
                            </div>
                        </div>
                    }
